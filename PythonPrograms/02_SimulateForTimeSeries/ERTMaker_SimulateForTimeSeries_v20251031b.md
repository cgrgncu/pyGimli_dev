# SimulateForTimeSeries(RUN_ERTMaker_SimulateForTimeSeries_v20251031b)
+ 作者: HsiupoYeh
+ 更新日期: 2026-01-13

### 版本
+ RUN_ERTMaker_SimulateForTimeSeries_v20251031b.py
...
\Lite_PyGimli_Env\ERTMaker_SimulateForTimeSeries_v20251031b.py
\Lite_PyGimli_Env\RUN_ERTMaker_SimulateForTimeSeries_v20251031b.bat
```
...
```
+ 呼叫方式: 運行「RUN_ERTMaker_SimulateForTimeSeries_v20251031b.bat」檔案，檔案內容:
```batch
.\PythonEnv\Python.exe RUN_ERTMaker_SimulateForTimeSeries_v20251031b.py
PAUSE
```
...
#                這個畫圖畫太多可能會吃掉過量記憶體越來越慢，這是matplotlib的內部問題...
#**************************************************************************
import json
import os
import shutil
