# ERTMaker_CreateAndModifyMesh_v20260112a.py
+ 作者: HsiupoYeh
+ 更新日期: 2026-01-12
...
\Lite_PyGimli_Env\ERTMaker_CreateAndModifyMesh_v20260112a.py
\Lite_PyGimli_Env\RUN_ERTMaker_CreateAndModifyMesh_v20260112a.bat
```
+ 呼叫方式: 運行「RUN_ERTMaker_CreateAndModifyMesh_v20260112a.bat」檔案，檔案內容:
```batch
.\PythonEnv\Python.exe ERTMaker_CreateAndModifyMesh_v20260112a.py
PAUSE
```
+ 編譯方式: 運行「COMPILE_ERTMaker_CreateAndModifyMesh_v20260112a.bat」檔案，檔案內容:
```batch
.\PythonEnv\Python.exe -m py_compile ERTMaker_CreateAndModifyMesh_v20260112a.py
PAUSE
```
...
#--------------------------------------------
# 版本資訊
VERSION_STR = 'v20260112a'
# 提示畫面
print('************************************************************')
print(f'* ERTMaker_CreateAndModifyMesh')
...
if os.path.exists(temp_filename): # 檢查檔案是否存在
    os.remove(temp_filename)     # 如果存在，就刪除
#--
# TempFile12_BasicMeshPNG_FileName
...
int_PaddingMesh_RectangleGrid_RightPaddingLayerCount = temp_json_data["PaddingMesh_RectangleGrid_RightPaddingLayerCount"]
...
```json
{
"CreateAndModifyMeshSettings_Version":"v20260112a",
"CreateAndModifyMeshSettings_Author":"HsiupoYeh",
"TempFile01_BasicMeshPNG_FileName_Readme":"不論Winodws或Linux或MAC作業系統一律使用「/」描述檔案路徑與資料夾路徑。",
"TempFile01_BasicMeshPNG_FileName":"Temp/CreateMesh_01_BasicMesh.png",
"TempFile02_BasicMeshVTK_FileName_Readme":"不論Winodws或Linux或MAC作業系統一律使用「/」描述檔案路徑與資料夾路徑。",
