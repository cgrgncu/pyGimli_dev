...
if A < M and M < N and N < B and M-A == N-M and N-M == B-N:
    print('WA(AMNB)')
# 考慮置換情形#1 AB顛倒 Array: B,M,N,A 且distance_BM=distance_MN=distance_NA
if B < M and M < N and N < A and M-B == N-M and N-M == A-N:
    print('WA#1(BMNA), Current=-I')
# 考慮置換情形#2 MN顛倒 Array: A,N,M,B 且distance_AN=distance_NM=distance_MB
if A < N and N < M and M < B and N-A == M-N and M-N == B-M:
    print('WA#2(ANMB), Voltage=-V')
# 考慮置換情形#3 AB顛倒 MN顛倒 Array: B,N,M,A 且distance_BN=distance_NM=distance_MA
if B < N and N < M and M < A and N-B == M-N and M-N == A-M:
    print('WA#3(BNMA), Current=-I, Voltage=-V')
#--    
# (b)Wenner-Beta(WB) Array: B,A,M,N 且distance_BA=distance_AM=distance_MN
# REF: Loke, M. H. (2004). Tutorial: 2-D and 3-D electrical imaging surveys. Figure 1.4
if B < A and A < M and M < N and A-B == M-A and M-A == N-M:
    print('WB(BAMN)')
# 考慮置換情形#1 AB顛倒 Array: A,B,M,N 且distance_AB=distance_BM=distance_MN
if A < B and B < M and M < N and B-A == M-B and M-B == N-M:
    print('WB#1(ABMN), Current=-I')
# 考慮置換情形#2 MN顛倒 Array: B,A,N,M 且distance_BA=distance_AN=distance_NM
if B < A and A < N and N < M and A-B == N-A and N-A == M-N:
    print('WB#2(BANM), Voltage=-V')
# 考慮置換情形#3 AB顛倒 MN顛倒 Array: A,B,N,M 且distance_AB=distance_BN=distance_NM
if A < B and B < N and N < M and B-A == N-B and N-B == M-N:
    print('WB#3(ABNM), Current=-I, Voltage=-V')
#--    
# (c)Wenner-Gamma(WG) Array: A,M,B,N 且distance_AM=distance_MB=distance_BN
# REF: Loke, M. H. (2004). Tutorial: 2-D and 3-D electrical imaging surveys. Figure 1.4
if A < M and M < B and B < N and M-A == B-M and B-M == N-B:
    print('WG(AMBN)')
# 考慮置換情形#1 AB顛倒 Array: B,M,A,N 且distance_BM=distance_MA=distance_AN
if B < M and M < A and A < N and M-B == A-M and A-M == N-A:
    print('WG#1(BMAN), Current=-I')
# 考慮置換情形#2 MN顛倒 Array: A,N,B,M 且distance_AN=distance_NB=distance_BM
if A < N and N < B and B < M and N-A == B-N and B-N == M-B:
    print('WG#2(ANBM), Voltage=-V')
# 考慮置換情形#3 AB顛倒 MN顛倒 Array: B,N,A,M 且distance_BN=distance_NA=distance_AM
if B < N and N < A and A < M and N-B == A-N and A-N == M-A:
    print('WG#3(BNAM), Current=-I, Voltage=-V')
#--
# (e)Dipole-Dipole(DD) Array: B,A,M,N 且distance_BA=distance_MN=a, distance_AM=na
# REF: Loke, M. H. (2004). Tutorial: 2-D and 3-D electrical imaging surveys. Figure 1.4
if B < A and A < M and M < N and A-B == N-M and (M-A)%(A-B) == 0:
    print('DD(BAMN)')
# 考慮置換情形#1 AB顛倒 Array: A,B,M,N 且distance_AB=distance_MN=a, distance_BM=na
if A < B and B < M and M < N and B-A == N-M and (M-B)%(B-A) == 0:
    print('DD#1(ABMN), Current=-I')
# 考慮置換情形#2 MN顛倒 Array: B,A,N,M 且distance_BA=distance_NM=a, distance_AN=na
if B < A and A < N and N < M and A-B == M-N and (N-A)%(A-B) == 0:
    print('DD#2(BANM), Voltage=-V')
# 考慮置換情形#3 AB顛倒 MN顛倒 Array: A,B,N,M 且distance_AB=distance_NM=a, distance_BN=na
if A < B and B < N and N < M and B-A == M-N and (N-B)%(B-A) == 0:
    print('DD#3(ABNM), Current=-I, Voltage=-V')
#--    
# (g)Wenner-Schlumberger(WS) Array: A,M,N,B 且distance_MN=a, distance_AM=distance_NB=na
# REF: Loke, M. H. (2004). Tutorial: 2-D and 3-D electrical imaging surveys. Figure 1.4
if A < M and M < N and N < B and M-A == B-N and (M-A)%(N-M) == 0:
    print('WS(AMNB)')
# 考慮置換情形#1 AB顛倒 Array: B,M,N,A 且distance_MN=a, distance_BM=distance_NA=na
if B < M and M < N and N < A and M-B == A-N and (M-B)%(N-M) == 0:
    print('WS#1(BMNA), Current=-I')
# 考慮置換情形#2 MN顛倒 Array: A,N,M,B 且distance_NM=a, distance_AN=distance_MB=na
if A < N and N < M and M < B and N-A == B-M and (N-A)%(M-N) == 0:
    print('WS#2(ANMB), Voltage=-V')
# 考慮置換情形#3 AB顛倒 MN顛倒 Array: B,N,M,A 且distance_BN=a, distance_NM=distance_MA=na
if B < N and N < M and M < A and N-B == A-M and (N-B)%(M-N) == 0:
    print('WS#3(BNMA), Current=-I, Voltage=-V')
#--   
```
...
#--------------------------------------------
print("載入OHM檔案...")
Output_Ohm_FileName='Output_ERTMaker_v299ScsvToUrf/XP1_SyntheticModel_CurrentFlowLinesAB.v299S.ohm'
